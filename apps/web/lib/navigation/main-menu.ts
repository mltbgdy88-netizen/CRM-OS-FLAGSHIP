...
export const MAIN_MENU: MainMenuItem[] = [
  ...
  { id: 'opportunities', label: 'Fırsatlar', href: '/opportunities', status: 'live', section: 'crm' },
  ...
  { id: 'products', label: 'Ürünler', href: '/products', status: 'live', section: 'crm' },
  { id: 'inventory', label: 'Envanter', href: '/inventory', status: 'live', section: 'operations' },
  { id: 'finance', label: 'Finans', href: '/finance', status: 'live', section: 'operations' },
